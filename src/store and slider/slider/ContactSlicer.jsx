...
const initialState = [
    {
      id: uuidv4(),
      photo:'https://i.pinimg.com/736x/80/e9/fd/80e9fdeb5548e1efa6fcaf28c0664761.jpg',
      firstName: 'Lwin Min',
      surName: 'Oo',
    ...
    {
        id: uuidv4(),
        photo:'https://i.pinimg.com/564x/f3/7d/34/f37d34650654d25711666a8460099929.jpg',
        firstName: 'Min Lwin',
        surName: 'Z',
...
export const { Add , Remove , MultiRemove } = ContactSlicer.actions
